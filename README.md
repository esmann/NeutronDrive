...
This is in now way affiliated with Proton, and is only published for demonstration purposes. Use at your own risk.  
...
--folder name of the folder to upload to, it will be created if it doesn't exist, defaults to root folder if not provided (do not support subfolders) 
```
